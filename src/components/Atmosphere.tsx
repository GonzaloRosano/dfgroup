 ...
 *   uLines   — horizontal shear / UV stretch echoing the lines strip

 *   uPreview — dims and tightens toward the preview frame
...
const FRAGMENT = /* glsl */ `
  ...
  void main() {
    ...
    float dim = 1.0 - uPreview * 0.38 - uLines * 0.08;
...
export default function Atmosphere() {
  ...
  useEffect(() => {
    ...
    const linesEl = document.querySelector('[data-atmosphere="lines"]');

    const previewEl = document.querySelector('[data-atmosphere="preview"]');
    ...
    const sampleBeats = () => {
      ...
      let l = linesEl ? presence(linesEl, vh, vh * 0.22) : 0;

      let p = previewEl ? presence(previewEl, vh, vh * 0.06) : 0;
